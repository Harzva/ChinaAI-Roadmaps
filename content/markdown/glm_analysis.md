...
![GLM 时间线](../../assets/images/670cca9e-dd8d-4152-8b18-21e2dc6d5006.png)
...
![GLM 技术路线流程图](../../assets/flowcharts/glm_flowchart_final.svg)
...
| --- | --- | --- |
| GLM: General Language Model Pretraining with Autoregressive Blank Infilling | `glm_autoregressive_blank_infilling.md` | `../html/glm_autoregressive_blank_infilling.html` |
| GLM‑130B: An Open Bilingual Pre‑trained Model | `glm_130b.md` | `../html/glm_130b.html` |
| WebGLM | `webglm.md` | `../html/webglm.html` |
| ChatGLM 系列（含 GLM‑4‑Air/4/4V/All Tools） | `glm_chatglm_family.md` | `../html/glm_chatglm_family.html` |
| GLM‑4.5 技术报告 | `glm_4_5.md` | `../html/glm_4_5.html` |
| GLM‑5 技术报告 | `glm_5.md` | `../html/glm_5.html` |
