window.ROADMAP_DATA = {
  ...
  captionTitle: "Agent OS · Runtime · Harness · Workspace",
  caption: "每个节点代表一个开源项目、产品形态或研究系统；关系线展示互补层级、适配方向和能力继承。",
  listTitle: "Agent Ecosystem / 生态索引",
  searchPlaceholder: "搜索 AIOS、Rivet、Codex、Hindsight、AgentWorkOS...",
