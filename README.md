...
4. 进入 [岗位与面试题库](https://harzva.github.io/Agent-Job-Interview/) 对齐岗位画像、公司专项、通用题库和实战训练。
5. 到 [论文下载中心](https://harzva.github.io/ChinaAI-Roadmaps/downloads.html) 打开原文，再回到 `content/markdown` 复盘关键贡献。
